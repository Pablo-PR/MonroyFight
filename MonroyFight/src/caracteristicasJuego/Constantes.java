...
public class Constantes {
	...
	public static final int NUM_POZOS=8;
	public static final int NUM_ROCAS=8;
	public static final int NUM_GEMAS=5;
	public static final int NUM_POCIONES=6;
	public static final int NUM_DINERO=20;
	public static final int MINIMO_JUGADORES=2;
	public static final int MAXIMO_JUGADORES=6;
	public static final int MINIMO_MOV_JUGADOR=1;
